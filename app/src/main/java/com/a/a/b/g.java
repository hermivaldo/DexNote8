...
public final class g<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    class a extends AbstractSet<Entry<K, V>> {
        ...
        public boolean contains(Object obj) {
            return (!(obj instanceof Entry) || g.this.a((Entry) obj) == null) ? false : g.f;
        }
    ...
    final class b extends AbstractSet<K> {
        ...
        public boolean remove(Object obj) {
            return g.this.b(obj) != null ? g.f : false;
        }
    ...
    private abstract class c<T> implements Iterator<T> {
        ...
        public final boolean hasNext() {
            return this.b != g.this.e ? g.f : false;
        }
    ...
    private boolean a(Object obj, Object obj2) {
        return (obj == obj2 || (obj != null && obj.equals(obj2))) ? f : false;
    }
